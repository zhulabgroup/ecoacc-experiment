...
path_data_gbif = "/Volumes/seas-zhukai/proj-ecoacc-experiment/PHACE/"
setwd(path_data_gbif)
# Read in data
gbif_data <- read.csv(" GBIF_thinned_phace.csv")
...
write.csv(chelsa_gbif,paste(path_out,'CHELSA_phace.csv'),row.names=F)
