# TITLE:          PHACE annual CHELSA data for GBIF
# AUTHORS:        Kara Dobson
...
path_data_gbif = "/nfs/turbo/seas-zhukai/proj-ecoacc/PHACE/"
setwd(path_data_gbif)
# Read in data
gbif_data <- read.csv(" GBIF_phace_limited.csv") # "GBIF_teracon_limited" data in turbo is only for ecoregion 8
...
write.csv(chelsa_gbif,paste(path_out,'CHELSA_phace_limited.csv'))
