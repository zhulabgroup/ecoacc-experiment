# TITLE:          Oklahoma annual CHELSA data for GBIF
# AUTHORS:        Kara Dobson
...
path_data_gbif = "/Volumes/seas-zhukai/proj-ecoacc-experiment/OK/"
...
write.csv(chelsa_gbif,paste(path_out,'CHELSA_ok.csv'),row.names=F)
