---
title: "Pairwise climate comparisons"
author: "Kara Dobson"
date: 2024-12-03
format: html
editor: visual
...
## Pairwise comparisons of all bioclim variables
...
```{r, message=F, warning=F, fig.width = 16, fig.height = 9}
...
```{r, message=F, warning=F, fig.width = 16, fig.height = 9}
chart.Correlation(chelsa_subset_tera, histogram=TRUE, pch=19)
```
