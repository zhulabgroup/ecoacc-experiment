# TITLE:          TeRaCON annual CHELSA data for different GBIF scales
# AUTHORS:        Kara Dobson
...
setwd(path_data)
# Load in data
tera_uscan <- read.csv(" gbif_teracon_uscan.csv")
tera_1000 <- read.csv(" gbif_teracon_1000.csv")
...
write.csv(chelsa_gbif_uscan,paste(path_out,'CHELSA_teracon_uscan.csv'))
write.csv(chelsa_gbif_1000,paste(path_out,'CHELSA_teracon_1000.csv'))
write.csv(chelsa_gbif_500,paste(path_out,'CHELSA_teracon_500.csv'))
