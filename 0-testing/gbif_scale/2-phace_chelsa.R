...
setwd(path_data)
# Load in data
phace_uscan <- read.csv(" gbif_phace_uscan.csv")
phace_1000 <- read.csv(" gbif_phace_1000.csv")
...
write.csv(chelsa_gbif_uscan,paste(path_out,'CHELSA_phace_uscan.csv'))
write.csv(chelsa_gbif_1000,paste(path_out,'CHELSA_phace_1000.csv'))
write.csv(chelsa_gbif_500,paste(path_out,'CHELSA_phace_500.csv'))
