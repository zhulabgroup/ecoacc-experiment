...
### Species contributing to warming effect each year; treatment effect and per treatment

```{r,message=F,warning=F,fig.width = 15, fig.height = 15}
#png("4_panel.png", units="in", width=15, height=14, res=300)
ggarrange(contours_shortterm_phace,contours_treat_shortterm_phace,
          point_contours_phace,point_contours_treat_phace,
          ncol=2,nrow=2)
#dev.off()
ggarrange(contours_shortterm_jrgce,contours_treat_shortterm_jrgce,
          point_contours_jrgce,point_contours_treat_jrgce,
          ncol=2,nrow=2)
ggarrange(contours_shortterm_tera,contours_treat_shortterm_tera,
          point_contours_tera,point_contours_treat_tera,
          ncol=2,nrow=2)
ggarrange(contours_shortterm_ok,contours_treat_shortterm_ok,
          point_contours_ok,point_contours_treat_ok,
          ncol=2,nrow=2)
ggarrange(contours_shortterm_hwrc,contours_treat_shortterm_hwrc,
          point_contours_hwrc,point_contours_treat_hwrc,
          ncol=2,nrow=2)
ggarrange(contours_shortterm_cfc,contours_treat_shortterm_cfc,
          point_contours_cfc,point_contours_treat_cfc,
          ncol=2,nrow=2)
```
...
```{r,message=F,warning=F,fig.width = 25, fig.height = 25}
phylo_all_comb_circ
```
